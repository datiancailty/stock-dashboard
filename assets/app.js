...
async function mutateStrategyFeedback(record){await requireAuth();await supabaseRpc('personal_append_strategy_feedback',{p_record:record});await loadPersonalPart('strategy',true);return record;}
