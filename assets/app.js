...
const RESEARCH_MATCH_SCALE='research_match_percent_0_to_100',RESEARCH_MATCH_SCHEMA_VERSION=3;
function researchMatchPercent(value,analysis=strategyAnalysis){if(typeof value!=='number'||!Number.isFinite(value)||!Number.isInteger(value)||Number(analysis?.schemaVersion)!==RESEARCH_MATCH_SCHEMA_VERSION||analysis?.confidenceScale!==RESEARCH_MATCH_SCALE||value<0||value>100)return null;return value;}
