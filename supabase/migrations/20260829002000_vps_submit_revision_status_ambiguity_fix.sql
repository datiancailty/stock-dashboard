...
-- Forward repair for the already-applied protocol-v2 submission RPC.
-- RETURNS TABLE output columns are PL/pgSQL variables.  The final unqualified
-- status predicate conflicted with the table column; qualify the target table.
-- Keep the Hosted Supabase pgcrypto schema in the locked SECURITY DEFINER path.
