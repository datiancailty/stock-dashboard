...
function researchMatchPercent(value,analysis=strategyAnalysis){const number=Number(value);if(Number(analysis?.schemaVersion)!==RESEARCH_MATCH_SCHEMA_VERSION||analysis?.confidenceScale!==RESEARCH_MATCH_SCALE||!Number.isInteger(number)||number<0||number>100)return null;return number;}
