-- Stock dashboard private identity/portfolio projection — Stage 3 design draft.
--
-- STATUS: DESIGN ONLY / DO NOT APPLY.
-- This file is intentionally kept under supabase/contracts rather than
-- supabase/migrations until the user reviews the contract and explicitly
-- authorizes a Hosted SQL execution. It assumes Stage 1, Stage 2, protocol v2,
-- and the v2 ACL closure already exist.
--
-- The draft creates:
--   * private username mapping with no browser table access;
--   * explicit private portfolio scopes and user memberships;
...
--
-- It does NOT create users, seed a user membership, import positions, enable
-- ARMED mode, call a provider, or modify the VPS.
